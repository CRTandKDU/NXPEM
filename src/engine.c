...
void engine_default_on_agenda_push( sign_rec_ptr sign,  struct val_rec * val ){
}

void engine_default_on_agenda_pop( sign_rec_ptr sign,  struct val_rec * val ){
}
